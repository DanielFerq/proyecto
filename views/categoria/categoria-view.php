  ...
  <div class="pd-ltr-20 xs-pd-20-10">
    <div class="min-height-200px">
        ...
        <div class="clearfix mb-20">
          ...
          <div class="pull-right">
            <?php if($_SESSION['permisosMod']['w']) { ?>
              <button id="btnNuevoCategoria" type="button" class="btn btn-primary" data-toggle="modal"
      ...
      <div class="pb-20 table-responsive">
        <table id="tableCategoria" class="data-table table table-bordered hover nowrap responsive">
          <thead>
