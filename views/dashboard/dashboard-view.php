    ...
    <div class="main-container">
      <div class="xs-pd-20-10 pd-ltr-20">
        <div class="title pb-20">
          <h2 class="h3 mb-0"><?= $data['page_title']; ?></h2>
        </div>
        ...
        <div class="row pb-10">
          <div class="col-md-8 mb-20">
            <div class="card-box height-100-p pd-20">
              ...
              >
                <div class="h5 mb-md-0">Reporte General</div>
                <div class="form-group mb-md-0">
                  <select class="form-control form-control-sm selectpicker">
                    <option value="">La semana pasada</option>
                    <option value="">El mes pasado</option>
                    <option value="">Último 6 meses </option>
                    <option value="">Último 1 año</option>
                  </select>
                </div>
              </div>
          ...
          <div class="col-md-4 mb-20">
            ...
            >
              <div class="d-flex justify-content-between pb-20 text-white">
                ...
                <div class="font-14 text-right">
                  <div><i class="icon-copy ion-arrow-up-c"></i> 2.1%</div>
                  <div class="font-12">Enero - 2023</div>
                </div>
              </div>
              <div class="d-flex justify-content-between align-items-end">
                <div class="text-white">
                  <div class="font-14">Ventas de hoy</div>
            ...
            <div class="card-box min-height-200px pd-20" data-bgcolor="#265ed7">
              <div class="d-flex justify-content-between pb-20 text-white">
                ...
                <div class="font-14 text-right">
                  <div><i class="icon-copy ion-arrow-down-c"></i> 3%</div>
                  <div class="font-12">Enero - 2023</div>
                </div>
              </div>
              <div class="d-flex justify-content-between align-items-end">
                <div class="text-white">
                  <div class="font-14">Producto sin stock</div>
                  <div class="font-24 weight-500">2</div>
                </div>
                <div class="max-width-150">
          ...
          <div class="col-lg-4 col-md-6 mb-20">
            <div class="card-box height-100-p pd-20 min-height-200px">
              <div class="d-flex justify-content-between pb-10">
                <div class="h5 mb-0">Top Clientes</div>
                <div class="dropdown">
                  <a
